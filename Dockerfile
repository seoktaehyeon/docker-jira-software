...
ADD https://github.com/QualitySphere/QualitySphere.github.io/raw/master/objects/mysql-connector-java-5.1.49.jar /opt/atlassian/jira/lib/mysql-connector-java-5.1.49.jar
