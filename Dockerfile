...
ADD https://qualitysphere.github.io/objects/mysql-connector-java-5.1.49-bin.jar /opt/atlassian/jira/lib/mysql-connector-java.jar
...
COPY tool/setMem.sh /usr/local/bin/setMem.sh
